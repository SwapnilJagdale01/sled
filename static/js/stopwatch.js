...
window.updateLap = function(lapSplitString, isReset){
  if(isReset){
    ...
    // alert(lapSplitString);
    // alert(wichButtonClick);

    // $('#'+wichButtonClick).text(lapSplitString);
    //
    // if(wichButtonClick == 'sheetTime'){
    //   $('#calculatedSheetTime').val(lapSplitString);
    //
    //   var timer0 =  Number(lapSplitString.split(':')[1])*60;
    //   var timer1 = Number(lapSplitString.split(':')[2]);
    //   var timer2 = Number(lapSplitString.split(':')[3])/100;
    //
    //   TCL1 = Number(timer0 + timer1 + timer2) / Number(Prod1);
    //   CL1 = Number(Math.round(TCL1)*MOL1*C);
    //
    //   $('#sheetCost').text(CL1);
    // }
    // if(wichButtonClick == 'cutTime'){
    //   $('#calculatedCutTime').val(lapSplitString);
    //
    //   var timer0 =  Number(lapSplitString.split(':')[1])*60;
    //   var timer1 = Number(lapSplitString.split(':')[2]);
    //   var timer2 = Number(lapSplitString.split(':')[3])/100;
    //
    //   TCL2 = Number(timer0 + timer1 + timer2) / Number(Prod2);
    //   CL2 = Number(Math.round(TCL2)*MOL2*C);
    //
    //   $('#cutCost').text(CL2);
    // }
    // if(wichButtonClick == 'foldTime'){
    //   $('#calculatedFoldTime').val(lapSplitString);
    //
    //   var timer0 =  Number(lapSplitString.split(':')[1])*60;
    //   var timer1 = Number(lapSplitString.split(':')[2]);
    //   var timer2 = Number(lapSplitString.split(':')[3])/100;
    //
    //   TCL3 = Number(timer0 + timer1 + timer2) / Number(Prod3);
    //   CL3 = Number(Math.round(TCL3)*MOL3*C);
    //
    //   $('#foldCost').text(CL3);
    // }
  }
